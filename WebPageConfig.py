...
def index():
        ...
        return render_template('home.html', dell=results[0], dellTime=times[0], vmware=results[1], vmwareTime=times[1], lenovo=results[2], lenovoTime=times[2], apc=results[3], apcTime=times[3], hpe=results[4],
